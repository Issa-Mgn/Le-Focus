    ...
    <div className="min-h-screen bg-neutral-50">
      <section className="page-hero">
        <div className="page-hero-inner">
          ...
          <p className="mt-3 font-serif text-[16px] text-neutral-500">{articles.length} article(s)</p>
        </div>
      </section>
      ...
      <section className="py-10">
        <div className="container-custom">
          {isLoading || articles.length > 0 ? (
            ...
            <div className="py-24 text-center font-serif text-[20px] text-neutral-500">Aucun article dans cette catégorie.</div>
          )}
        </div>
      </section>
    </div>
